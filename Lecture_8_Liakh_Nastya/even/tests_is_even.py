...
# def test_is_neg_1_false():
#     assert m.is_even(-1) == False

# def test_is_neg_8_true():
...
# # m.nameUpper
# def test_nameUpper_steve():
#     assert m.nameUpper('steve') == 'STEVE'

# # python -m pytest tests_is_even.py имя_файла_внутри_папки_без_точек
